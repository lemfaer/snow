		...
		<div class="row">
			<div class="col-md-12">
				<div class="header-left">
					...
					<div class="menu">
						<a class="toggleMenu" href="#"><img src="/template/images/nav.png" alt="" /></a>
						<ul class="nav" id="nav">
						...
						<li>
							...
							<ul class="sub-icon1 list">
								<div class="product_control_buttons">
									<a href="#"><img src="/template/images/edit.png" alt=""/></a>
									<a href="#"><img src="/template/images/close_edit.png" alt=""/></a>
								</div>
								<div class="clear"></div>
