...
--
-- Хост: 127.0.0.1
-- Время создания: Май 10 2016 г., 21:29
...
INSERT INTO `cargo` (`id`, `indent_id`, `available_id`, `count`, `status`) VALUES
(7, 4, 262, 1, 1),
(8, 4, 191, 1, 1),
(9, 4, 153, 1, 1),
(10, 4, 167, 1, 1),
...
INSERT INTO `contact` (`id`, `name`, `phone`, `address`, `user_id`, `status`) VALUES
(2, 'Привет', '+38 (000) 123-12-34', 'Приветное, Крым', 0, 1),
(3, '123', '+38 (132) 123-42-34', 'Адрес Дома, проспект Героев Сталинграда, Николаев, Николаевская область, Украина', 0, 1),
(4, 'Проверка 234', '+38 (000) 232-33-21', 'руанда', 0, 1),
(11, 'Имя', '+38 (000) 000-00-00', 'Миколаївська область, Украина', 2, 1);
...
(0, '/_default/700.jpg', '/_default/135.jpg', '/_default/50.jpg', 1),
...
(86, '/b5/ea/f23acd2536.jpg', '/33/5d/3c3e1c7ecc.jpg', '/2e/67/fa426ac34f.jpg', 1);
...
INSERT INTO `indent` (`id`, `contact_id`, `state_id`, `status`) VALUES
(4, 2, 1, 1),
(5, 3, 1, 1),
(6, 4, 1, 1),
(10, 11, 4, 1),
...
(1, 'Новый заказ', 1),
(2, 'Заказ обрабатывается', 1),
(3, 'Заказ доставляется', 1),
(4, 'Заказ выполнен', 1);
...
INSERT INTO `user` (`id`, `first_name`, `last_name`, `email`, `login`, `password`, `is_admin`, `hash`, `status`) VALUES
(0, 'no', 'no', 'no', 'anonym', 'no', 0, 'no', 1),
(1, '', '', '', 'admin', '4a225ea05f3a199443848ac2f9d9e360', 1, '2537c8d076f7726821cd122670228b17', 1),
(2, 'Имя', 'Фамилия', 'email@mail.com', 'login', '696d29e0940a4957748fe3fc9efd22a3', 0, '2452596fa9c9f0c8e31a991864f3a9ee', 1);
...
--
ALTER TABLE `cargo`
  ADD CONSTRAINT `fk_indent_has_available_available1` FOREIGN KEY (`available_id`) REFERENCES `available` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_indent_has_available_indent1` FOREIGN KEY (`indent_id`) REFERENCES `indent` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `indent`
  ADD CONSTRAINT `fk_indent_contact1` FOREIGN KEY (`contact_id`) REFERENCES `contact` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_indent_state1` FOREIGN KEY (`state_id`) REFERENCES `state` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
